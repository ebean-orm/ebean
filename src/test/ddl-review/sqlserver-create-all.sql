...
create sequence gen_key_sequence_seq as bigint start with 1 increment by 50;
...
create sequence t_detail_with_other_namexxxyy_seq as bigint start with 1 increment by 50;
...
create sequence t_atable_thatisrelatively_seq as bigint start with 1 increment by 50;
