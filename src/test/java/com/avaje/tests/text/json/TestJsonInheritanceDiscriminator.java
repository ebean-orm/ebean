...
public class TestJsonInheritanceDiscriminator extends TestCase {
  ...
  public void testNoDiscriminator() {
    ...
    assertEquals(cat.getId(), cat3.getId());
    assertEquals(cat.getName(), cat3.getName());
    assertEquals(cat.getVersion(), cat3.getVersion());
