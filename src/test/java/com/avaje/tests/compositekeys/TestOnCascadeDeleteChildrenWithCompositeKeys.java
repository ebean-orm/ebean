...
public class TestOnCascadeDeleteChildrenWithCompositeKeys extends BaseTestCase {
	...
	@Entity @Table(name = "user") public static class User {
		private Long id;
		private String name;
	...
	@Entity @Table(name = "user_role") public static class UserRole implements Serializable {
	...
	@Entity @Table(name = "role") public static class Role {
		private Long id;
		private String name;
		private Set<UserRole> userRoles;
