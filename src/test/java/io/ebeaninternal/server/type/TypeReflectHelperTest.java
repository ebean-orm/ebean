...
public class TypeReflectHelperTest {
  ...
  public void getParams_MoneyTypeConverter() {
    ...
    Class<?>[] params0 = TypeResolver.resolveRawArgs(AttributeConverter.class, MoneyTypeConverter.class);
    ...
    assertThat(params0[0]).isEqualTo(Money.class);
    assertThat(params0[1]).isEqualTo(BigDecimal.class);
  }

  @Test
  public void getParams_OidTypeConverter() {

    Class<?>[] params0 = TypeResolver.resolveRawArgs(ScalarTypeConverter.class, OidTypeConverter.class);
    ...
    assertThat(params0[0]).isEqualTo(Oid.class);
    assertThat(params0[1]).isEqualTo(Long.class);
  }

  @Test
  public void getParams_SysTimeConverter() {

    Class<?>[] params0 = TypeResolver.resolveRawArgs(ScalarTypeConverter.class, SysTimeConverter.class);
    ...
    assertThat(params0[0]).isEqualTo(SysTime.class);
    assertThat(params0[1]).isEqualTo(Timestamp.class);
  }

  @Test
  public void getParams_RichTextConverter() {

    Class<?>[] params0 = TypeResolver.resolveRawArgs(ScalarTypeConverter.class, RichTextConverter.class);
    assertThat(params0.length).isEqualTo(2);
    assertThat(params0[0]).isEqualTo(RichText.class);
    assertThat(params0[1]).isEqualTo(byte[].class);

    // failing test here with NPE
