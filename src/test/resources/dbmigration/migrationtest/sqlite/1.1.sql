...
alter table migtest_e_basic add column new_boolean_field int default true not null;
update migtest_e_basic set new_boolean_field = old_boolean;

alter table migtest_e_basic add column new_boolean_field2 int default true not null;
...
alter table migtest_e_softdelete add column deleted int default false not null;
