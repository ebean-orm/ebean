...
-- NOT YET IMPLEMENTED: alter table migtest_e_basic add constraint uq_mgtst__b_vs45xo unique  (description);
...
-- NOT YET IMPLEMENTED: alter table migtest_e_basic add constraint uq_mgtst__b_ucfcne unique  (status,indextest1);
-- NOT YET IMPLEMENTED: alter table migtest_e_basic add constraint uq_mgtst__bsc_nm unique  (name);
-- NOT YET IMPLEMENTED: alter table migtest_e_basic add constraint uq_mgtst__b_4ayc00 unique  (indextest4);
-- NOT YET IMPLEMENTED: alter table migtest_e_basic add constraint uq_mgtst__b_4ayc01 unique  (indextest5);
