...
alter table migtest_e_basic add new_string_field varchar(255) not null, constraint df_migtest_e_basic_new_string_field default 'foo' for new_string_field;
alter table migtest_e_basic add new_boolean_field bit not null, constraint df_migtest_e_basic_new_boolean_field default 1 for new_boolean_field;
update migtest_e_basic set new_boolean_field = old_boolean;

alter table migtest_e_basic add new_boolean_field2 bit not null, constraint df_migtest_e_basic_new_boolean_field2 default 0 for new_boolean_field2;
alter table migtest_e_basic add progress integer not null, constraint ck_migtest_e_basic_progress check ( progress in ('0','1','2')), constraint df_migtest_e_basic_progress default 0 for progress;
