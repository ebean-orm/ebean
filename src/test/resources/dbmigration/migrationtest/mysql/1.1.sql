...
alter table migtest_e_basic alter some_date set default { ts '2000-01-01 00:00:00' };
...
alter table migtest_e_basic add column new_boolean_field tinyint(1) default true not null;
update migtest_e_basic set new_boolean_field = old_boolean;

alter table migtest_e_basic add column new_boolean_field2 tinyint(1) default true not null;
...
alter table migtest_e_softdelete add column deleted tinyint(1) default false not null;
