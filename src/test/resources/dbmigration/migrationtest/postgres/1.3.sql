...
alter table migtest_oto_child add constraint uq_m12_otoc71 unique  (uqfoo(name));
alter table migtest_oto_master add constraint uq_migtest_oto_master_fooname unique  (foo(name));
create index ix_migtest_e_basic_indextest1 on migtest_e_basic (indextest1);
create index ix_migtest_e_basic_indextest5 on migtest_e_basic (indextest5);
create index ix_m12_otoc71 on migtest_oto_child (foo(name));
create index ix_migtest_oto_master_fooname on migtest_oto_master (foo(name));
