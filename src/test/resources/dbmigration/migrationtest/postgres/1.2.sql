...
alter table migtest_e_history alter column test_string type varchar(255);
alter table migtest_e_history_history alter column test_string type varchar(255);
