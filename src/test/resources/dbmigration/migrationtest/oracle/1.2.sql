...
alter table migtest_e_basic add column old_boolean number(1) not null default 0;
...
alter table migtest_e_history modify test_string varchar2(255);
alter table migtest_e_history_history modify test_string varchar2(255);
