...
alter table migtest_e_basic add new_boolean_field number(1) default 0 not null;
update migtest_e_basic set new_boolean_field = old_boolean;

alter table migtest_e_basic add new_boolean_field2 number(1) default 0 not null;
