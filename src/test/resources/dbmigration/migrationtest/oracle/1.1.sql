...
alter table migtest_e_basic add column new_boolean_field2 number(1) not null default 0;
alter table migtest_e_basic add column progress number(10) not null constraint ck_migtest_e_basic_progress check ( progress in ('0','1','2')) default 0;
